...
public class BrowserActivity extends AppCompatActivity implements BrowserController {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (BrowserContainer.size() < 1) {
            ...
            addAlbum(getString(R.string.app_name), Objects.requireNonNull(sp.getString("favoriteURL", "https://github.com/K3rn3l-P/FBrowser/browser/wiki")), true, false, "");
        }
    }
        ...
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_BACK:
                if (bottomAppBar.getVisibility() == View.GONE) hideOverview();
                    ...
                    Log.v(TAG, "FBrowser in fullscreen mode");
    ...
    public synchronized void removeAlbum(final AlbumController controller) {
        ...
        if (BrowserContainer.size() <= 1) {
            if (!sp.getBoolean("sp_reopenLastTab", false)) doubleTapsQuit();
                ...
                ninjaWebView.loadUrl(Objects.requireNonNull(sp.getString("favoriteURL", "https://github.com/K3rn3l-P/FBrowser/browser/wiki")));
                hideOverview(); }}
        else {
            ...
            if (menuItem.getItemId() == R.id.page_1) {
                ...
                popup.setOnMenuItemClickListener(item -> {
                    if (item.getItemId() == R.id.menu_delete) {
                        ...
                        Uri webpage = Uri.parse("https://github.com/K3rn3l-P/FBrowser/browser/wiki/Overview");
    ...
    private void showOverflow() {
        ...
        overflow_help.setOnClickListener(v -> {
            ...
            Uri webpage = Uri.parse("https://github.com/K3rn3l-P/FBrowser/browser/wiki");
            BrowserUnit.intentURL(this, webpage); });
        ...
        menu_grid_tab.setOnItemClickListener((parent, view14, position, id) -> {
            ...
            if (position == 0)
                ...
                addAlbum(getString(R.string.app_name), Objects.requireNonNull(sp.getString("favoriteURL", "https://github.com/K3rn3l-P/FBrowser/browser/wiki")), true, true, "");
    ...
    private void showDialogFastToggle() {
        ...
        if (url != null) {
            ...
            button_help.setOnClickListener(view -> {
                dialog.cancel();
                Uri webpage = Uri.parse("https://github.com/K3rn3l-P/FBrowser/browser/wiki/Fast-Toggle-Dialog");
                BrowserUnit.intentURL(this, webpage);
            });
        } else {
    ...
    private void showDialogFilter() {
        ...
        button_help.setOnClickListener(view -> {
            dialog.cancel();
            Uri webpage = Uri.parse("https://github.com/K3rn3l-P/FBrowser/browser/wiki/Filter-Dialog");
            BrowserUnit.intentURL(this, webpage);
        });
